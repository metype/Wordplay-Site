...
import { hasProtocol, parseQuery, isEqual, joinURL, parseURL, withBase, withQuery } from 'ufo';
...
const components = {};
function _47home_47runner_47work_47Wordplay_45Site_47Wordplay_45Site_47_46nuxt_47components_46plugin_46mjs(nuxtApp) {
...
const _47home_47runner_47work_47Wordplay_45Site_47Wordplay_45Site_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin = defineNuxtPlugin((nuxtApp) => {
...
const _47home_47runner_47work_47Wordplay_45Site_47Wordplay_45Site_47node_modules_47nuxt_47dist_47head_47runtime_47plugin = defineNuxtPlugin((nuxtApp) => {
...
const _47home_47runner_47work_47Wordplay_45Site_47Wordplay_45Site_47node_modules_47nuxt_47dist_47app_47plugins_47router = defineNuxtPlugin((nuxtApp) => {
...
const script = 'const w=window,de=document.documentElement,knownColorSchemes=["dark","light"],preference=window.localStorage.getItem("nuxt-color-mode")||"night";let value=preference==="system"?getColorScheme():preference;const forcedColorMode=de.getAttribute("data-color-mode-forced");forcedColorMode&&(value=forcedColorMode),addColorScheme(value),w["__NUXT_COLOR_MODE__"]={preference,value,getColorScheme,addColorScheme,removeColorScheme};function addColorScheme(e){const o=""+e+"-mode",t="";de.classList?de.classList.add(o):de.className+=" "+o,de.setAttribute("data-"+t,e)}function removeColorScheme(e){const o=""+e+"-mode",t="";de.classList?de.classList.remove(o):de.className=de.className.replace(new RegExp(o,"g"),""),de.removeAttribute("data-"+t)}function prefersColorScheme(e){return w.matchMedia("(prefers-color-scheme"+e+")")}function getColorScheme(){if(w.matchMedia&&prefersColorScheme("").media!=="not all"){for(const e of knownColorSchemes)if(prefersColorScheme(":"+e).matches)return e}return"light"}\n';
const _47home_47runner_47work_47Wordplay_45Site_47Wordplay_45Site_47node_modules_47_64nuxtjs_47color_45mode_47dist_47runtime_47plugin_46server = defineNuxtPlugin((nuxtApp) => {
...
const _plugins = [
  preload,
  _47home_47runner_47work_47Wordplay_45Site_47Wordplay_45Site_47_46nuxt_47components_46plugin_46mjs,
  _47home_47runner_47work_47Wordplay_45Site_47Wordplay_45Site_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin,
  _47home_47runner_47work_47Wordplay_45Site_47Wordplay_45Site_47node_modules_47nuxt_47dist_47head_47runtime_47plugin,
  _47home_47runner_47work_47Wordplay_45Site_47Wordplay_45Site_47node_modules_47nuxt_47dist_47app_47plugins_47router,
  _47home_47runner_47work_47Wordplay_45Site_47Wordplay_45Site_47node_modules_47_64nuxtjs_47color_45mode_47dist_47runtime_47plugin_46server
];
...
const _sfc_main$7 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><button class="statistics-button absolute" title="Show Statistics"><svg style="${serverRenderer.exports.ssrRenderStyle({ "width": "24px", "height": "24px" })}" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2C8.13 2 5 5.13 5 9C5 11.38 6.19 13.47 8 14.74V17C8 17.55 8.45 18 9 18H15C15.55 18 16 17.55 16 17V14.74C17.81 13.47 19 11.38 19 9C19 5.13 15.87 2 12 2M14 13.58V16H13V11.41L14.71 9.71C15.1 9.32 15.1 8.68 14.71 8.29C14.32 7.9 13.68 7.9 13.29 8.29L12 9.59L10.71 8.29C10.32 7.9 9.68 7.9 9.29 8.29C8.9 8.68 8.9 9.32 9.29 9.71L11 11.41V16H10V13.58C8.23 12.81 7 11.05 7 9C7 6.24 9.24 4 12 4S17 6.24 17 9C17 11.05 15.77 12.81 14 13.58M9 20H15V21C15 21.55 14.55 22 14 22H10C9.45 22 9 21.55 9 21V20Z"></path></svg></button><div class="color-theme-buttons"><button class="light color-theme-button" title="Light Mode"><svg style="${serverRenderer.exports.ssrRenderStyle({ "width": "24px", "height": "24px" })}" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2C8.13 2 5 5.13 5 9C5 11.38 6.19 13.47 8 14.74V17C8 17.55 8.45 18 9 18H15C15.55 18 16 17.55 16 17V14.74C17.81 13.47 19 11.38 19 9C19 5.13 15.87 2 12 2M14 13.58V16H13V11.41L14.71 9.71C15.1 9.32 15.1 8.68 14.71 8.29C14.32 7.9 13.68 7.9 13.29 8.29L12 9.59L10.71 8.29C10.32 7.9 9.68 7.9 9.29 8.29C8.9 8.68 8.9 9.32 9.29 9.71L11 11.41V16H10V13.58C8.23 12.81 7 11.05 7 9C7 6.24 9.24 4 12 4S17 6.24 17 9C17 11.05 15.77 12.81 14 13.58M9 20H15V21C15 21.55 14.55 22 14 22H10C9.45 22 9 21.55 9 21V20Z"></path></svg></button><button class="dark color-theme-button" title="Dark Mode"><svg style="${serverRenderer.exports.ssrRenderStyle({ "width": "24px", "height": "24px" })}" viewBox="0 0 24 24"><path fill="currentColor" d="M9 20H15V21C15 21.55 14.55 22 14 22H10C9.45 22 9 21.55 9 21V20M19 9C19 11.38 17.81 13.47 16 14.74V17C16 17.55 15.55 18 15 18H9C8.45 18 8 17.55 8 17V14.74C6.19 13.47 5 11.38 5 9C5 5.13 8.13 2 12 2S19 5.13 19 9M14.71 8.29C14.32 7.9 13.68 7.9 13.29 8.29L12 9.59L10.71 8.29C10.32 7.9 9.68 7.9 9.29 8.29C8.9 8.68 8.9 9.32 9.29 9.71L11 11.41V16H13V11.41L14.71 9.71C15.1 9.32 15.1 8.68 14.71 8.29Z"></path></svg></button><button class="night color-theme-button" title="Night Mode"><svg style="${serverRenderer.exports.ssrRenderStyle({ "width": "24px", "height": "24px" })}" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2A9.91 9.91 0 0 0 9 2.46A10 10 0 0 1 9 21.54A10 10 0 1 0 12 2Z"></path></svg></button></div></div>`);
    };
  }
});
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ControlButtons.vue");
...
const __default__$2 = {
  ...
  mounted() {
    const vals = ["", "for-player", "for-competition"];
    setInterval(() => {
      this.val = vals[state.boardState[this.index]];
    }, 100);
  }
};
...
const __default__$1 = {
  ...
  mounted() {
    if (localStorage.getItem("wins") == void 0 || localStorage.getItem("losses") == void 0 || localStorage.getItem("games") == void 0) {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      serverRenderer.exports.ssrRenderList(_ctx.alphabet, (group, i) => {
        ...
        _push(`<!--[-->`);
        serverRenderer.exports.ssrRenderList(group, (letter, j) => {
          _push(serverRenderer.exports.ssrRenderComponent(_component_Letter, {
            index: j + i * 7
          }, {
            default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${serverRenderer.exports.ssrInterpolate(letter)}`);
              } else {
                return [
                  vue_cjs_prod.createTextVNode(vue_cjs_prod.toDisplayString(letter), 1)
                ];
              }
            }),
            _: 2
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<!--[-->`);
  if ($data.state.showPopup) {
    _push(`<div class="absolute hv-center full-cover" data-v-67ab5f94></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<div class="${serverRenderer.exports.ssrRenderClass(`absolute hv-center ${$data.state.popupType == "stats" ? `board` : `board-short`} ${$data.state.showPopup ? `slide-up` : `slide-down`}`)}" data-v-67ab5f94>`);
  if ($data.state.popupType == "help") {
    _push(`<div data-v-67ab5f94><h1 class="absolute h-center" data-v-67ab5f94>Instructions</h1><div class="hl h-center absolute" style="${serverRenderer.exports.ssrRenderStyle({ "top": "5rem" })}" data-v-67ab5f94></div><h3 class="absolute justified" style="${serverRenderer.exports.ssrRenderStyle({ "top": "6rem" })}" data-v-67ab5f94>Take Turns Against A Random Player Using Words To Toggle Letters On The Board. Whichever Player First Gets 40% Of The Board In Their Favour Wins!</h3></div>`);
  } else if ($data.state.popupType == "stats") {
    _push(`<div data-v-67ab5f94><h1 class="absolute h-center" data-v-67ab5f94>Statistics</h1><h2 class="absolute" style="${serverRenderer.exports.ssrRenderStyle({ "top": "7rem", "left": "2rem" })}" data-v-67ab5f94>Games</h2><h2 class="absolute" style="${serverRenderer.exports.ssrRenderStyle({ "top": "7rem", "right": "2rem" })}" data-v-67ab5f94>${serverRenderer.exports.ssrInterpolate($data.games)}</h2><h2 class="absolute" style="${serverRenderer.exports.ssrRenderStyle({ "top": "17rem", "left": "2rem" })}" data-v-67ab5f94>Wins</h2><h2 class="absolute" style="${serverRenderer.exports.ssrRenderStyle({ "top": "17rem", "right": "2rem" })}" data-v-67ab5f94>${serverRenderer.exports.ssrInterpolate($data.wins)}</h2><h2 class="absolute" style="${serverRenderer.exports.ssrRenderStyle({ "top": "27rem", "left": "2rem" })}" data-v-67ab5f94>Losses</h2><h2 class="absolute" style="${serverRenderer.exports.ssrRenderStyle({ "top": "27rem", "right": "2rem" })}" data-v-67ab5f94>${serverRenderer.exports.ssrInterpolate($data.losses)}</h2><div class="vl h-center absolute" data-v-67ab5f94></div><div class="hl h-center absolute" data-v-67ab5f94></div></div>`);
  } else if ($data.state.popupType == "next-game") {
    _push(`<div data-v-67ab5f94><h1 class="absolute h-center" data-v-67ab5f94>${serverRenderer.exports.ssrInterpolate($options.wonPrompt)}</h1><div class="hl h-center absolute" style="${serverRenderer.exports.ssrRenderStyle({ "top": "5rem" })}" data-v-67ab5f94></div><button class="play-again-button h-center absolute" style="${serverRenderer.exports.ssrRenderStyle({ "bottom": "3rem" })}" title="Play Game" data-v-67ab5f94>${serverRenderer.exports.ssrInterpolate($options.playPrompt)}</button></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<button class="exit absolute" data-v-67ab5f94>x</button></div><!--]-->`);
}
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-67ab5f94"]]);
const __default__ = {
  props: {
    index: Number
  }
...
const _sfc_main$1 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
        class: "notification absolute h-center",
        style: `opacity:${Math.min(vue_cjs_prod.unref(state).notifications[__props.index].life / 100, 1)};top: calc(calc(5rem * ${__props.index}) + 1rem);`
      }, _attrs))} data-v-146bd4f3><h3 data-v-146bd4f3>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(state).notifications[__props.index].text)}</h3></div>`);
    };
  }
});
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-146bd4f3"]]);
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(state).notifications, (notification, i) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_Notification, { index: i }, null, _parent));
      });
      _push(`<!--]--><!--]-->`);
    };
  }
